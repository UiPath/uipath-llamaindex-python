...
def create_normalizing_processor() -> AttributeNormalizingSpanProcessor:
    """Create span processor that normalizes LlamaIndex tool attributes."""
    processor = AttributeNormalizingSpanProcessor()
    logger.info("Span processor added: tool attribute normalization")
    return processor
