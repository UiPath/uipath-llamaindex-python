...
@function_tool
def get_translation_preferences(ctx: RunContextWrapper[Context]) -> str:
...
def main() -> Agent[Context]:
    ...
    orchestrator_agent = Agent[Context](
